...
#define DJI_VERSION_MINOR   14  /*!< DJI SDK minor version num, when add functionality in a backwards compatible manner changes. Range from 0 to 99. */
...
#define DJI_VERSION_BUILD   2316 /*!< DJI SDK version build info, when jenkins trigger build changes. Range from 0 to 65535. */
